#4. Calculator
#Create a calculator that works with two numbers. Allow this calculator to add,
#subtract, multiply, and divide. Based on which one you pick, allow the 
#program to display your answer.
